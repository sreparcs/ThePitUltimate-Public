...
@ArmorOnly
public class GirlsBandCry extends AbstractEnchantment implements ITickTask, MovementHandler {
    ...
    @SneakyThrows
    public GirlsBandCry() {
        this.music = NBSDecoder.parse(ThePit.getInstance().getClass().getClassLoader().getResourceAsStream("GirlsBandCry.nbs"));
